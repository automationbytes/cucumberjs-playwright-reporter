...
const output_file = './.jsreport/output.json';
...
function generateReport(options) {
  fs.ensureDir('./.jsreport')
  
  fs.writeJson('./.jsreport/output.json', {
  "Scenarios_Passed": 0,
  "Scenarios_Skipped": 0,
  "Scenarios_Total": 0,
  "Scenarios_Failed": 0,
  ...
  "Featurecount_Passed": 0,
  "Featurecount_Failed": 0,
  "Featurecount_Total": 0,
  "Features": [
  ],  
  "ExecutionStartTime":"",
  "TotalExecutionTime":"",
...
=====================================================================================\n`)
  ...
  async function _parseFeatures(suite) {
    suite.features.forEach((feature) => {
      ...
      // fs.copy('./output.json', 'report/output.json', err => {
      //   if (err) return console.error(err)
      //   console.log('success!')
      // }) // copies file
     console.log(feature)
      featurename.push(feature.name)
    //  console.log(featurename)
     ...
     // console.log(feature.name)
      ...
      // console.log(feature.scenarios.failed)
      // console.log(feature.scenarios.passed)
     // console.log(feature.scenarios.total)
...
await updater(output_file).set(	"Featurecount_Passed",	suite.featureCount.passed)

await updater(output_file).set(	"Featurecount_Failed",	suite.featureCount.failed)
await updater(output_file).set(	"Featurecount_Total",	suite.featureCount.total)
await updater(output_file).set(	"Features",	featurename)      
await updater(output_file).set("TotalExecutionTime",moment().format('MMMM Do YYYY, h:mm:ss a'))
}
  ...
  function _parseScenarios(feature) {
    ...
    feature.isSkipped = feature.scenarios.total === feature.scenarios.skipped;
     //console.log(feature.scenario.passed)
    // console.log(feature.scenario.total)
  ...
  function _parseSteps(scenario) {
    scenario.steps.forEach((step) => {
      ...
      //  console.log(RESULT_STATUS.passed)
