  ...
  async function _parseFeatures(suite) {
    suite.features.forEach((feature) => {
      ...
      var featurearr = {
        ...
        Scenario_Count: feature.scenarios.total,
        Scenario_Passed_Count: feature.scenarios.passed,
        Scenario_Failed_Count: feature.scenarios.failed,
        Scenario_Skipped_Count: feature.scenarios.skipped,
      };
    ...
    await updater(output_file).set(
      "Features_PassedPercentage",
      _calculatePercentage(suite.featureCount.passed, suite.featureCount.total)
    );
    await updater(output_file).set(
      "Features_FailedPercentage",
      _calculatePercentage(suite.featureCount.failed, suite.featureCount.total)
    );
    ...
    await updater(output_file).set(
      "Scenarios_PassedPercentage",
      suite.scenarios.passedPercentage
    );
    await updater(output_file).set(
      "Scenarios_FailedPercentage",
      suite.scenarios.failedPercentage
    );
  }
